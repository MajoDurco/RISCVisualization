...
export function writeback(instruction, registers, ui){
  ...
  if(dest !== false) { // LINE
    if(is_jumping){
      ...
      ui.addTo(`${first_op} is more of equal ${second_op}, jump is not executed`, 'state_line_msg')
      return false
    }
  }
  else { // REGISTER
    if(is_jumping) {
      ...
      ui.addTo(`${first_op} is more or equal ${second_op}, jump is not executed`, 'state_line_msg')
      return false
    }
  } 
}
